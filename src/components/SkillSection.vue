...
// Import SVG definitions from HeroSection
const techSvgs = {
  js: {
    viewBox: "0 0 48 48",
    color: "#ffd600",
  ...
  mongodb: {
    ...
    paths: [
      ...
      {
        d: "m64.918 54.849l-.512.596c-.14-.299-.286-.545-.375-.811c-2.226-6.671-4.439-13.344-6.667-20.014a4618.057 4618.057 0 0 0-5.169-15.367c-.081-.24-.25-.449-.379-.672l4.625-6.084c.146.194.354.367.429.581c1.284 3.76 2.556 7.523 3.822 11.289c1.182 3.518 2.346 7.04 3.542 10.552c.08.235.359.401.545.601l.01.798l.129 18.526z",
        fill: "#57AE47",
        fillRule: "evenodd",
      },
      {
...
const skills = [
  ...
  { name: "MongoDB", icon: techSvgs.mongodb },
  ...
  <section id="skills" class="py-16 sm:py-20 md:py-24 transition-colors">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      >
        ...
        <div
          class="absolute w-full h-full mt-10 gallery-container transform-style-3d flex justify-center"
        >
          <!-- Gallery Track (Rotates) -->
          <div
            class="absolute flex items-center justify-center w-full h-full gallery-track transform-style-3d"
          >
            <div
...
.card-floater {
  ...
  pointer-events: auto; /* Only visible cards capture hover */
}
