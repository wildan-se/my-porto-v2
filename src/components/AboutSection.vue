...
const fullCodeLines = [
  {
    line: 1,
    content: `<span class="text-pink-500">const</span> <span class="text-blue-400">bio</span> = {`,
  },
  {
    line: 2,
  ...
  {
    line: 7,
    content: `&nbsp;&nbsp;&nbsp;&nbsp;<span class="text-green-400">'Web Development'</span>,`,
  },
  {
    line: 8,
    content: `&nbsp;&nbsp;&nbsp;&nbsp;<span class="text-green-400">'Network Engineering'</span>`,
  },
  { line: 9, content: `&nbsp;&nbsp;],` },
  {
    line: 10,
...
<template>
  <section
    id="about"
    class="py-16 sm:py-20 md:py-24 transition-colors"
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          ...
          <div
            class="bg-[#2d2d2d] px-3 sm:px-4 py-2 sm:py-3 flex items-center justify-between border-b border-black"
          >
            <div class="flex space-x-1.5 sm:space-x-2">
              <div
                class="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-[#ff5f56]"
              ></div>
              <div
                class="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-[#ffbd2e]"
              ></div>
              <div
                class="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-[#27c93f]"
              ></div>
            </div>
            <div
          ...
          <!-- Editor Area -->
          <div
            class="p-4 sm:p-6 md:p-8 overflow-x-auto min-h-[300px] sm:min-h-[350px]"
          >
            <div
              class="font-mono text-xs sm:text-sm md:text-base leading-relaxed flex"
            >
              <!-- Static Line Numbers -->
              <div
          ...
          <!-- Bottom Status Bar -->
          <div
            class="bg-[#007acc] px-3 sm:px-4 py-1 flex items-center justify-between text-[9px] sm:text-[10px] md:text-xs text-white font-mono"
          >
            <div class="flex items-center space-x-2 sm:space-x-4">
              <span class="flex items-center gap-1"
                ><span class="i-git-branch">master*</span></span
              >
            ...
            <div class="flex items-center space-x-2 sm:space-x-4">
              ...
              <span class="hidden sm:inline">JavaScript</span>
            </div>
          </div>
        </div>
      </div>
