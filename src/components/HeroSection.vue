...
const techSvgs = {
  ...
  iot: {
     ...
     color: "#0091EA",
     paths: [
       { d: "M5 13v9H3v-9Zm18 0v2h-2v7h-2v-7h-2v-2Zm-11-2a7.537 7.537 0 0 1 3.96 1.149l1.447-1.45A9.522 9.522 0 0 0 12 9a9.363 9.363 0 0 0-5.333 1.68l1.449 1.453A7.36 7.36 0 0 1 12 11Z", fill: "#000000" },
       { d: "M12 7a11.494 11.494 0 0 1 6.834 2.27l1.427-1.43A13.48 13.48 0 0 0 12 5a13.333 13.333 0 0 0-8.186 2.822l1.426 1.43A11.343 11.343 0 0 1 12 7Z", fill: "#000000" },
       { d: "M12 3a15.471 15.471 0 0 1 9.687 3.41l1.427-1.429A17.43 17.43 0 0 0 .96 4.964l1.427 1.429A15.328 15.328 0 0 1 12 3Zm0 10a4.5 4.5 0 1 0 4.5 4.5A4.5 4.5 0 0 0 12 13Zm0 7a2.5 2.5 0 1 1 2.5-2.5A2.5 2.5 0 0 1 12 20Z", fill: "#000000" }
     ]
  },
  html: {
    viewBox: "0 0 256 256",
    color: "#E34C26",
    paths: [
      { d: "M0 0h256v256H0z", fill: "none" }, // Optional sizing box
  ...
  css: {
    ...
    paths: [
      ...
      { d: "M60.484 0h38.68v16.176H76.66v16.176h22.506v16.175H60.484V0Zm46.417 0h38.681v14.066h-22.505v2.813h22.505v32.352h-38.68V34.46h22.505v-2.813H106.9V0Zm46.418 0H192v14.066h-22.505v2.813H192v32.352h-38.681V34.46h22.505v-2.813H153.32V0Z", fill: "#000000" }, // Assuming black for text
...
const techIcons = [
  { name: 'JavaScript', icon: techSvgs.js, pos: 'top: -20px; right: -20px;', delay: '0s' },
  { name: 'Vue.js', icon: techSvgs.vue, pos: 'bottom: 10px; left: -30px;', delay: '1.5s' },
  { name: 'PHP', icon: techSvgs.php, pos: 'top: 60%; right: -50px;', delay: '3s' },
  { name: 'Mikrotik', icon: techSvgs.mikrotik, pos: 'top: -30px; left: 20px;', delay: '4.5s' },
  { name: 'IoT', icon: techSvgs.iot, pos: 'bottom: -20px; right: 30px;', delay: '2s' },
  { name: 'HTML', icon: techSvgs.html, pos: 'top: 10%; left: -40px;', delay: '0.5s' },
  { name: 'CSS', icon: techSvgs.css, pos: 'bottom: 40%; left: -50px;', delay: '2.5s' },
  { name: 'Tailwind', icon: techSvgs.tailwind, pos: 'top: -40px; right: 40px;', delay: '1s' },
  { name: 'Node.js', icon: techSvgs.node, pos: 'bottom: -40px; left: 50%;', delay: '3.5s' },
  { name: 'Bootstrap', icon: techSvgs.bootstrap, pos: 'top: 80%; right: -30px;', delay: '4s' },
  { name: 'Express', icon: techSvgs.express, pos: 'top: -50px; left: 60%;', delay: '5s' },
  { name: 'MongoDB', icon: techSvgs.mongodb, pos: 'bottom: 20%; right: -60px;', delay: '1.2s' },
  { name: 'MySQL', icon: techSvgs.mysql, pos: 'top: 25%; left: -50px;', delay: '2.8s' },
];
...
<template>
  <section id="home" class="relative min-h-screen flex items-center overflow-hidden p-6 pt-24 ">
    ...
    <div ref="heroContainerTarget" class="max-w-6xl mx-auto px-4 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center h-full will-change-transform origin-center">
      
      <!-- 3D Geometric Portrait (Left Side) -->
      <div class="relative flex justify-center md:justify-end order-1 md:order-1 h-[400px] perspective-1000 group cursor-pointer md:pr-8">
        ...
        <div ref="portraitTarget" class="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 transform-style-3d transition-transform duration-75 ease-out will-change-transform">
          ...
          <div ref="layer1Target" class="absolute inset-0 border-2 border-indigo-500/30 rounded-3xl will-change-transform">
           ...
           <div ref="layer2Target" class="absolute inset-4 bg-linear-to-br from-indigo-600 to-purple-600 rounded-3xl opacity-20 will-change-transform">
          ...
          <div 
            ...
            :key="icon.name"
            class="absolute z-30 p-2 bg-white dark:bg-slate-800 rounded-xl shadow-xl animate-float"
          ...
          >
             <svg 
               ...
               class="w-8 h-8"
               :class="{ 'dark:brightness-0 dark:invert': ['Mikrotik', 'Express', 'IoT'].includes(icon.name) }"
      ...
      <!-- Text Side (Right) -->
      <div class="text-center md:text-left order-2 md:order-2 z-10 md:pl-8">
        ...
        <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 text-slate-800 dark:text-white leading-tight">
          Muhammad 
          <span class="text-transparent bg-clip-text bg-linear-to-r from-indigo-500 to-purple-600 dark:from-indigo-400 dark:to-purple-400">Wildan Septiano</span>
        </h1>
